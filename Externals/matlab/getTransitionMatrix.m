function [ transitionMatrix columnStates ] = getTransitionMatrix(markovChain,Norder, Nstates)
%%
...
if Norder == 1,
    ...
    %transitionMatrix = transitionMatrix/(numel(markovChain)-1);
%     normalization = sum(transitionMatrix,2);
%     transitionMatrix = bsxfun(@rdivide, transitionMatrix, normalization);
